"""
Django settings for member_clone project.
...
SECRET_KEY = '+5xa6548bia=jurzlqf$o$ly7e8s!%k#97fuc6vztagiv#3fmh'
...
ROOT_URLCONF = 'member_clone.urls'
...
WSGI_APPLICATION = 'member_clone.wsgi.application'
